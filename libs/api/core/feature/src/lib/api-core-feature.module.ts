...
import { ApiAccountFeatureModule } from '@nxpm-mobile/api/account/feature'
import { ApiAuthFeatureModule } from '@nxpm-mobile/api/auth/feature'
import { ApiUserFeatureModule } from '@nxpm-mobile/api/user/feature'
